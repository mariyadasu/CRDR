...
import { calendarTracker, appointmentSlotsTracker, 
  appointmentSlot, currentAppointment, aaDateSlotObject } from '@aa/structures/calendar.tracker.interface';
...
export class DashboardComponent implements OnInit {
  ...
  @ViewChild('template') public openPopupForNoSlots: TemplateRef<any>;
  	...
  	ngOnInit() 
  	{
      //console.log(this.aaa.getuserInfo().userId);

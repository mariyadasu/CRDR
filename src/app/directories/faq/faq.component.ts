...
export class FaqComponent implements OnInit {
	...
	cities: city[] = [];
  	...
  	ngOnInit() 
  	{
  		this.cs.setPageTitle('Frequently Asked Questions, Customer Support – Ask Apollo');
      	this.cs.setPageDescription('Find Frequently Asked Questions by Patients on Appointments, Schedules and Payment Procedures. Browse Ask Apollo’s FAQs section to lower your risks of complications.');

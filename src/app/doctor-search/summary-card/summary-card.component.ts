...
import { Component, OnInit, Input, ViewChild, ChangeDetectorRef, OnDestroy,TemplateRef } from '@angular/core';
...
export class SummaryCardComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() 
  {
    //console.log('login type summaery card - '+localStorage.getItem("loginType"));
    //console.log(this.doc.objSEOSchemaonDoctorProfile);
    ...
    //this.seoSchemaForDoctorProfile = JSON.stringify(this.seoSchemaForDoctorProfile);
    ...
    this.profileURL = '/' + this.utilsService.sanitizeURLParam(this.doc.CityName) + '/' + this.utilsService.sanitizeURLParam(this.doc.keyword) + '/' + this.utilsService.sanitizeURLParam(this.doc.doctorName);
  ...
  slotSelected(cs: appointmentSlot) {
    console.log('login type summaery card & slot selected - '+localStorage.getItem("loginType"));
    ...
    if (loginType == 'M') {
      console.log('login type summaery card & Redirection - '+localStorage.getItem("loginType"));
      if (userState == "nsnu") {
